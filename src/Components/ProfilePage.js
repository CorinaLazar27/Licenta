    ...
    <div className="nav">
      ...
      <div className="home1">
        ...
        <div className="container-xl px-4 mt-4">
          <div id="notesucces">Profilul a fost actualizat cu succes!</div>
          <div id="note">Eroare la actualizarea profilului!</div>
        ...
        */}
            <div className="col-xl-16">
              <div className="card mb-3">
                <div className="card-header">Detalii cont</div>
                    ...
                    <div className="row gx-3 mb-3">
                      ...
                      <div className="col-md-6">
                        ...
                        <input
                          ...
                          onChange={(event) => {
                            setLocationUpdate(event.target.value);
